...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mobile_apps_app', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'App.published'
        db.add_column('mobile_apps_app', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'App.user'
        db.delete_column('mobile_apps_app', 'user_id')

        # Deleting field 'App.published'
        db.delete_column('mobile_apps_app', 'published')
