...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile_levels', (
        ...
        db.create_unique('accounts_userprofile_levels', ['userprofile_id', 'level_id'])

        # Adding M2M table for field content_areas on 'UserProfile'
        db.create_table('accounts_userprofile_content_areas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['accounts.userprofile'], null=False)),
            ('contentarea', models.ForeignKey(orm['core.contentarea'], null=False))
        ))
        db.create_unique('accounts_userprofile_content_areas', ['userprofile_id', 'contentarea_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_userprofile_levels')

        # Removing M2M table for field content_areas on 'UserProfile'
        db.delete_table('accounts_userprofile_content_areas')
